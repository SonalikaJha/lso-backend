...
router.get('/leadFilter', AuthMiddleware, name('lead.list', true), LeadController.indexFilter);
...
router.post('/followup-data', AuthMiddleware,name('lead.list', true), DashboardController.getFollowUpData);
router.post('/followup-notification', AuthMiddleware,name('lead.list', true), DashboardController.followUpNotification);
// Routes
